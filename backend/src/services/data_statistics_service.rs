    ...
    async fn save_statistics(&self, stats: &DataStatistics) -> ApiResult<()> {
        ...
        sqlx::query(
            ...
            ON DUPLICATE KEY UPDATE
                ...
                total_data_size = VALUES(total_data_size),
                total_index_size = VALUES(total_index_size),
                top_tables_by_size = VALUES(top_tables_by_size),
                top_tables_by_access = VALUES(top_tables_by_access),
                mv_total = VALUES(mv_total),
                mv_running = VALUES(mv_running),
                mv_failed = VALUES(mv_failed),
                mv_success = VALUES(mv_success),
                schema_change_running = VALUES(schema_change_running),
                schema_change_pending = VALUES(schema_change_pending),
                schema_change_finished = VALUES(schema_change_finished),
                schema_change_failed = VALUES(schema_change_failed),
                active_users_1h = VALUES(active_users_1h),
