...
pub struct Cluster {
    ...
    pub fe_mapping: Option<serde_json::Value>,
}
...
impl From<Cluster> for ClusterResponse {
    fn from(cluster: Cluster) -> Self {
        ...
        let deployment_mode = match cluster.deployment_mode.as_str() {
            "shared_data" => DeploymentMode::SharedData,
            _ => DeploymentMode::SharedNothing,
        };
...
impl Cluster {
    ...
    pub fn is_shared_data(&self) -> bool {
        self.deployment_mode == "shared_data"
    }
